...
function seedDatabase(database) {
  ...
  // Рецепты (10+ записей)
  const recipes = [
    ['Овсяная каша с бананом', 'Классический завтрак', '1. Залейте овсянку молоком. 2. Варите 5 минут. 3. Добавьте нарезанный банан.', 5, 10, 1, 350, 10, 8, 60, 'https://images.unsplash.com/photo-1517673400267-0251440c45dc?w=400', 1, 2, 1, 1],
    ['Куриный суп с овощами', 'Лёгкий и полезный суп', '1. Отварите курицу. 2. Добавьте овощи. 3. Варите 20 минут.', 10, 30, 4, 280, 25, 6, 30, 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400', 2, 3, 1, 1],
    ['Салат Цезарь', 'Классический рецепт', '1. Обжарьте курицу. 2. Нарвите салат. 3. Смешайте с соусом.', 15, 10, 2, 420, 32, 24, 18, 'https://images.unsplash.com/photo-1550304943-4f24f54ddde9?w=400', 3, 1, 1, 1],
    ['Запечённый лосось', 'Полезный ужин', '1. Замаринуйте лосося. 2. Запекайте 20 минут при 180°C.', 10, 20, 2, 450, 35, 25, 5, 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=400', 4, 2, 1, 1],
    ['Гречка с грибами', 'Сытный гарнир', '1. Отварите гречку. 2. Обжарьте грибы. 3. Смешайте.', 5, 25, 4, 320, 12, 5, 60, 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400', 5, 4, 1, 1],
    ['Творожная запеканка', 'ПП десерт', '1. Смешайте творог с яйцом. 2. Запекайте 30 минут.', 10, 30, 6, 250, 20, 8, 30, 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400', 6, 3, 1, 1],
    ['Смузи боул', 'Яркий завтрак', '1. Взбейте банан с ягодами. 2. Украсьте гранолой.', 10, 0, 2, 380, 8, 12, 65, 'https://images.unsplash.com/photo-1590301157890-4810ed352733?w=400', 1, 5, 1, 1],
    ['Курица с брокколи', 'Фитнес-ужин', '1. Обжарьте курицу. 2. Приготовьте брокколи на пару.', 10, 20, 2, 380, 40, 14, 20, 'https://images.unsplash.com/photo-1598103442097-8b74394b95c6?w=400', 4, 2, 1, 1],
    ['Рис с овощами', 'Веганский ужин', '1. Отварите рис. 2. Обжарьте овощи. 3. Смешайте с соевым соусом.', 10, 20, 3, 350, 8, 4, 70, 'https://images.unsplash.com/photo-1512058564366-18510be2db19?w=400', 5, 4, 1, 1],
    ['Омлет с помидорами', 'Быстрый завтрак', '1. Взбейте яйца. 2. Добавьте помидоры. 3. Жарьте 5 минут.', 3, 10, 1, 280, 18, 18, 5, 'https://images.unsplash.com/photo-1484723091739-30a097e8f929?w=400', 1, 3, 1, 1],
    ['Авокадо тост', 'Трендовый завтрак', '1. Поджарьте хлеб. 2. Разомните авокадо. 3. Добавьте специи.', 5, 5, 1, 320, 7, 18, 35, 'https://images.unsplash.com/photo-1541519227354-08fa5d50c44d?w=400', 1, 2, 1, 1],
    ['Тыквенный крем-суп', 'Осенний согревающий суп', '1. Запеките тыкву. 2. Взбейте блендером со сливками.', 15, 40, 4, 210, 5, 8, 30, 'https://images.unsplash.com/photo-1476718406336-bb5a9690ee2a?w=400', 2, 1, 1, 1]
  ];
